		...
		<section>
			...
			<form id="registro" class="registro" action="validar_registro.php" method="post">
				...
				<div id="paquetes" class="paquetes">
					<h3>Elige el numerode boletos</h3>
				...
				<div id="eventos" class="eventos clearfix">
					...
					<div id="resumen" class="resumen">
						...
						<div class="caja clearfix">
							<div class="extras">
								<div class="orden">
									<label for="camisa">Camisa del evento $10 <small>(promocion 7% descuento)</small></label>
									<input type="number" min="0" id="camisa" size="3" name="pedido_camisas" placeholder="0">
								</div><!--orden-->
								<div class="orden">
